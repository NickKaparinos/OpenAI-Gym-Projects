"""
Open AI Gym InvertedDoublePendulum-v2
Nick Kaparinos
2021
"""
...
if __name__ == '__main__':
    ...
    # Training
    trainer_hyperparameters = {'max_epoch': 4, 'step_per_epoch': 20_000, 'step_per_collect': 10,
    ...
    # Execution Time
    end = time.perf_counter()  # tensorboard --logdir './MuJoCo/InvertedDoublePendulum/logs'
