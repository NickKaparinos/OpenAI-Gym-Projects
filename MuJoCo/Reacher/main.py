...
if __name__ == '__main__':
    ...
    train_envs = ts.env.DummyVectorEnv([lambda: make_env() for _ in range(num_envs)])
    test_envs = ts.env.DummyVectorEnv([lambda: make_env() for _ in range(num_envs)])
    ...
    # Training
    trainer_hyperparameters = {'max_epoch': 4, 'step_per_epoch': 250_000, 'step_per_collect': 1,
